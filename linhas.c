...
void preenche(pline p, pline linhas,pstation paragens_sistema, int total_sistema)
{
    ...
    do {
        printf("\nInsira quantas estac�es pretende adicionar: ");
        scanf("%d", &n);
        // Verifica que o utilizador n�o est� a tentar adicionar mais esta��es do que as existentes no sistema, uma vez que n�o podem existir esta��es iguais numa linha.
        if (n > total_sistema) {
            printf("\nErro: N�o pode adicionar mais esta��es do que as existentes no sistema!");
        }
...
pline addline(pline linhas, pstation paragens_sistema, int total_sistema)
{
    ...
    // Verifica se o utilizador quer adicionar manualmente ou atrav�s de um ficheiro
    do {
        printf("\nDeseja adicionar manualmente ou por ficheiro (.txt)? (1 - Manualmente, 0 - Ficheiro): ");

        // Verifica se o utilizador n�o introduziu um caracter inv�lido.
        if(scanf("%d", &manual) != 1)
        {
            while (getchar() != '\n')
                continue;
    ...
    if(manual)
    {
        ...
        // Adiciona a linha � lista de linhas
    ...
    char codigo[5];
        ...
        if (aux != NULL) {
            ...
            do {
                ...
                // Verifica se a esta��o a adicionar n�o est� na linha.
                do {
                ...
                // Verifica se a esta��o a adicionar existe no sistema, se existir, adiciona-a � linha.
            ...
            switch (choice) {
                case 1:
                    do {
                        ...
                        // Verifica se a linha ir� ficar com mais esta��es do que as existentes no sistema.
                        if(n > total_sistema)
                        {
                            printf("\nErro: N�o pode adicionar mais esta��es do que as existentes no sistema!");
                        }
...
pline addfromfile(pline p, char *nome, pstation paragens_sistema, int total_sistema)
{
    ...
    else
    {
        ...
        run = p;
        // Verifica se j� existe uma linha com o mesmo nome.
        while(run != NULL )
        {
        ...
        while(fscanf(f," %108[^\n]",tempstring) == 1)
        {
            ...
            // Le o codigo da esta�ao. (4 caracteres, come�ando no espa�o apos # "i+2")
            // Como os nomes e codigos das esta��es est�o separados por " # ", e i encontra-se no primeiro espa�o, i+2 � o primeiro caracter do codigo.
            ...
            // Verifica se o codigo da esta��o existe no sistema.
            for(i = 0; i<total_sistema; i++)
            {
                if(strcmp(novo->stations_in_line[novo->station_count].codigo,paragens_sistema[i].codigo) == 0)
                {
                    valido = 1;
                    // printf("\nSucesso!");
                    // Se o codigo estiver correto mas o nome n�o, altera o nome, uma vez que � mais provavel o utilizador cometer erros ao escrever o nome, do que o c�digo.
            ...
            // Caso o codigo n�o exista no sistema, a linha n�o � valida, logo sai do loop.
            if(valido == 0)
                break;
...
// Fun��o para eliminar uma linha do sistema. Baseada nos powerpoints apresentados nas aulas te�ricas.
pline delline(pline p)
{
    char nome[100];
    ...
    // Libertar as mem�rias alocadas ao array dinamico e struct line.
...
// Fun��o de teste usada para criar um ficheiro com uma linha.
void savelinetofile(pline p)
{
    FILE *f;
